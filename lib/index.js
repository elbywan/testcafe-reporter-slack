...
var quiet = process.env['TESTCAFE_SLACK_QUIET'] || false;
...
exports['default'] = function () {
    return {
        ...
        reportTaskStart: function reportTaskStart(startTime, userAgents, testCount) {
            ...
            if (!quiet) this.slacker.send({ action: 'sendMessage', data: 'Starting testcafe ' + startTime + '. \n Running tests in: ' + userAgents });
        },
        ...
        reportTaskDone: function reportTaskDone(endTime, passed, warnings) {
            ...
            if (!quiet || this.testCount - passed > 0) this.slacker.send({ action: 'sendReport', data: this.testCount - passed });
        }
    };
};
